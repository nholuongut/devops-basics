...
- ➡️ [DevOps Roadmap](https://github.com/nholuongut/DevOps-Roadmap)

## DevOps topics 🔥

We cover a wide range of DevOps topics in our content library, explore them under [**topics**](./topics/). You can also refer to [**DevOps Roadmap**](https://github.com/nholuongut/DevOps-Roadmap) to see where each topic fits in the toolchain
...
<table>
    ...
    <tr>
        ...
        <td>📖 <a href="https://github.com/nholuong/devops-basic/blob/main/topics/architecture/README.md">architecture/README.md</a></td>
    ...
    <tr>
        ...
        <td>📖 <a href="https://github.com/nholuong/devops-basic/blob/main/topics/sql/README.md">sql/README.md</a></td>
...
- For additional resources to practice these tools, visit: [**Nho Luong - Project**](https://github.com/nholuongut)
